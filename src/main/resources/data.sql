...
INSERT IGNORE INTO usuario (id, rut, nombre, apellidos, email, direccion, region, comuna, rol, password, activo, fecha_creacion) 
VALUES (1, '11111111-1', 'Admin', 'Sistema', 'tejedoraypunto@gmail.com', '', 'Metropolitana', 'Santiago', 'ADMIN', 'admin123', true, NOW());
...
(4, 'Chaleco Brisa', 'Tejido ligero perfecto para las tardes de verano', 45000, 2, 'img/summer/chaleco_v1.jpeg', 2, true, NOW()),
(5, 'Chaleco Marino', 'Diseño fresco con punto calado', 42000, 3, 'img/summer/chaleco_v2.jpeg', 2, true, NOW()),
(6, 'Chaleco Sunset', 'Tejido en algodón con detalles románticos', 48000, 1, 'img/summer/chaleco_v3.jpeg', 2, true, NOW()),
-- Categoría: Bikini
(7, 'Bikini Océano', 'Tejido en algodón con detalles de conchas', 32000, 2, 'img/summer/bikini1.jpeg', 3, true, NOW()),
(8, 'Bikini Coral', 'Diseño bohemio con punto calado', 35000, 3, 'img/summer/bikini2.jpeg', 3, true, NOW()),
(9, 'Bikini Sirena', 'Tejido delicado con detalles brillantes', 38000, 2, 'img/summer/bikini3.jpeg', 3, true, NOW()),

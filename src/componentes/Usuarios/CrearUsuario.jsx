...
export function CrearUsuario() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.nombre || !formData.email || !formData.password || !formData.region || !formData.comuna) {
    ...
    const [msgPassword, validoPassword] = validarPassword(formData.password);
    const [msgNombre, validoNombre] = validarNombre(formData.nombre);

    if (!validoEmail || !validoPassword || !validoNombre) {
  ...
  return (
    <>
      <NavbarAdmi />
      <div className="container crear-usuario-container">
        <div className="row justify-content-center">
          <div className="col-12 col-md-10 col-lg-8">
            <div className="card shadow-sm mt-4 mb-4">
              <div className="card-body">
                <h3 className="card-title mb-4 text-center">Crear Nuevo Usuario</h3>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    {mensajes.password && (
                      <small className={mensajes.password.includes('✔️') ? 'text-success' : 'text-danger'}>
                        {mensajes.password}
                      </small>
                    )}
                  </div>

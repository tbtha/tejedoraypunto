...
const {getProductosDB, createUserDB, getUserMailDB, crearProductoDB, editarProductoDB, eliminarProductoDB, traernombreproductoDB, getUserDB} = require("../database/db")
